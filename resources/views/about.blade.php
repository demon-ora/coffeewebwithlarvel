    ...
    <div class="container">
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-md-6">
                    <p>The Perfect COFFEE launched in 2020, in the heart of Patan dhoka. Our mission is simple. We want to teach coffee drinkers all over the world how to make the perfect blend!
        ...
        <div class="row">
            <div class="box">
                ...
                <div class="col-sm-4 text-center">
                    <img class="img-responsive" src="{{url('forntend/img/ani5.jpg')}}" alt="">
                    <h3>BEK</h3>
                </div>
                <div class="col-sm-4 text-center">
                    <img class="img-responsive" src="{{url('forntend/img/ani1.jpg')}}" alt="">
                    <h3>NOOB</h3>
                </div>
                <div class="col-sm-4 text-center">
                    <img class="img-responsive" src="{{url('forntend/img/ani1.jpg')}}" alt=""> 
